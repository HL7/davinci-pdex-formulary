...
* extension[MemberPlanReference].valueReference = Reference(InsuranceDrugPlanD1002)
...
* type = $PlanNetInsuranceProductTypeVS#mediadv
...
* contact[patient-plan-contact][0].telecom.value = "+1 (888) 555-1212"
...
* name = "Sample Medicare Advantage Part D Drug Plan"
//* alias MS
* period.start = "2021-01-01"
* period.end = "2021-12-31"
...
* contact[patient-drugplan-contact][0].purpose = http://terminology.hl7.org/CodeSystem/contactentity-type#PATINF
* contact[patient-drugplan-contact][0].telecom.system = #phone
* contact[patient-drugplan-contact][0].telecom.value = "+1 (888) 555-1212"

* contact[patient-drugplan-contact][1].purpose = http://terminology.hl7.org/CodeSystem/contactentity-type#PATINF
* contact[patient-drugplan-contact][1].name.text = "Sample Medicare Advantage Drug Plan Formulary Website"
* contact[patient-drugplan-contact][1].telecom.system = #url
* contact[patient-drugplan-contact][1].telecom.value = "http://url/to/health/plan/information"

* contact[patient-drugplan-contact][2].purpose = http://terminology.hl7.org/CodeSystem/contactentity-type#PATINF
* contact[patient-drugplan-contact][2].name.text = "Sample Medicare Advantage Drug Plan Benefit Website"
* contact[patient-drugplan-contact][2].telecom.system = #url
* contact[patient-drugplan-contact][2].telecom.value = "http://url/to/health/plan/information"
...
* extension[usdf-MailOrder-extension].valueBoolean = false
...
* extension[usdf-MailOrder-extension].valueBoolean = true
* code = InsuranceItemTypeCS#formulary-item "Formulary Item"
...
*/
/*
Instance: PayerInsurancePlanA1002-MarketingURL
InstanceOf: InsurancePlanEndpoint
Description: "Endpoint for Acme of CT Portal"
Usage: #example
* id = "endpoint1"
* status = #active
// TODO update to be an http/https endpoint type when vs is added
* connectionType = http://terminology.hl7.org/CodeSystem/endpoint-connection-type#hl7-fhir-rest
* name = "Sample Medicare Advantage Plan Marketing Website"
* address = "http://url/to/health/plan/information"
*/

Instance: StateOfCTLocation
InstanceOf: InsurancePlanLocation
Description: "State of CT Area"
Usage: #example
* meta.profile = Canonical(InsurancePlanLocation) 
