...
* extension[DrugPlanReference].valueReference = Reference(InsuranceDrugPlanD3002)
...
* contact[patient-plan-contact][=].telecom.value = "+1 (888) 555-3002"
...
Instance: InsuranceDrugPlanD3002
InstanceOf: InsuranceDrugPlan
Description: "Insurance Drug Plan D3002"
Usage: #example
...
* contact[patient-drugplan-contact][=].telecom.value = "+1 (888) 555-3002"
...
* plan[=].specificCost[0].benefit[0].cost[copay].qualifiers = CopayOptionCS#before-deductible "Before Deductible"

* plan[=].specificCost[0].benefit[0].cost[coinsurance].type = BenefitCostTypeCS#coinsurance "Coinsurance"
* plan[=].specificCost[0].benefit[0].cost[coinsurance].value.value = 1
